...
import { clearTestDatabase, createTestUser, generateUniqueUsername } from "../../utils/test-helpers";
...
describe('PostService', () => {
  ...
  describe('updatePost', () => {
    it('should update post content', async () => {
      const post = await postService.createPost(testUser.id, 'Original content');
    ...
    it('should return null for non-existent post', async () => {
      const result = await postService.updatePost(99999, testUser.id, 'New content');
