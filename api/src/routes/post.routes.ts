...
router.get('/', authMiddleware, (req, res) => postController.getAllPosts(req, res));
router.get('/user/:username', authMiddleware, (req, res) => postController.getPostsByAuthor(req, res));
